...
const newQuizQuestions: QuizQuestion[] = [
  ...
  // ĐỀ CƯƠNG – Bài 1: Vocabulary & Grammar (Mixed Units)
  { id: 71, question: "Mother Earth _____ us with air, water and food.", options: ["keeps", "protects", "provides", "produces"], correct: 2, explanation: "Provide sb with sth = cung cấp cho ai cái gì.", unit: 10 },
  { id: 72, question: "_____ animals can cause ecological imbalances.", options: ["Chasing", "Preserving", "Hunting", "Grazing"], correct: 2, explanation: "Hunting animals = săn bắt động vật → gây mất cân bằng sinh thái.", unit: 10 },
  { id: 73, question: "To keep ecologies in _____, we need to protect natural resources.", options: ["reserve", "balance", "good", "protection"], correct: 1, explanation: "In balance = trong trạng thái cân bằng.", unit: 10 },
  { id: 74, question: "One way to _____ people's awareness is to follow the 3Rs.", options: ["rise", "preserve", "protect", "raise"], correct: 3, explanation: "Raise awareness = nâng cao nhận thức. Rise (tự tăng) ≠ Raise (làm tăng).", unit: 10 },
  { id: 75, question: "Many activities cause _____, also called habitat destruction.", options: ["climate change", "habitat loss", "ecological balance", "global warming"], correct: 1, explanation: "Habitat loss = mất môi trường sống = habitat destruction.", unit: 10 },
  { id: 76, question: "Orange trees and cactuses are flowering plants, _____ have seeds.", options: ["who", "which", "that", "what"], correct: 1, explanation: "Which dùng cho vật. Non-defining clause (có dấu phẩy).", unit: 10 },
  { id: 77, question: "A naturalist, _____ studies the natural world, often observes organisms.", options: ["that", "which", "who", "what"], correct: 2, explanation: "Who dùng cho người trong non-defining clause.", unit: 10 },
  { id: 78, question: "Humans cut down trees on Earth, _____ lungs are jungles and forests.", options: ["whose", "which", "who", "that"], correct: 0, explanation: "Whose chỉ sở hữu: 'lá phổi của Trái Đất'.", unit: 10 },
  { id: 79, question: "The cycle of seasons brings changes, _____ requires animals to adapt.", options: ["whose", "that", "which", "who"], correct: 2, explanation: "Which bổ sung thông tin cho cả mệnh đề trước.", unit: 10 },
  { id: 80, question: "Scientists use the Hubble Telescope, _____ began orbiting in 1990.", options: ["whose", "that", "who", "which"], correct: 3, explanation: "Which cho vật trong non-defining clause.", unit: 10 },
  { id: 81, question: "We need a _____ stove that we can easily pack and transport.", options: ["changeable", "rechargeable", "portable", "transferable"], correct: 2, explanation: "Portable = xách tay, di động.", unit: 11 },
  { id: 82, question: "When humans use habitat for farming, they cause _____.", options: ["habitat loss", "climate change", "global warming", "ecological balance"], correct: 0, explanation: "Habitat loss = mất môi trường sống.", unit: 10 },
  { id: 83, question: "It is very important _____ over the words and grammatical points.", options: ["copy", "to copy", "go", "to go"], correct: 3, explanation: "It is important + to V. 'Go over' = xem xét lại, ôn tập.", unit: 9 },
  { id: 84, question: "The latest smartwatch is stylish and _____, easy to carry.", options: ["interactive", "virtual", "portable", "heavy"], correct: 2, explanation: "Portable = di động, dễ mang theo.", unit: 11 },
  { id: 85, question: "Being _____ means you can speak two languages well.", options: ["bilingual", "concentric", "established", "various"], correct: 0, explanation: "Bilingual = song ngữ.", unit: 9 },
  ...
  // ĐỀ CƯƠNG – Synonym / Antonym
  { id: 92, question: "CLOSEST meaning: The castle has become a 'ruinous' site.", options: ["ancient", "damaged", "modern", "banned"], correct: 1, explanation: "Ruinous ≈ damaged = bị hư hại, đổ nát.", unit: 8 },
  { id: 93, question: "CLOSEST meaning: A 'package holiday' is ideal for families.", options: ["group tour", "complete trip", "individual journey", "planned travel"], correct: 1, explanation: "Package holiday ≈ complete trip = kỳ nghỉ trọn gói.", unit: 8 },
  { id: 94, question: "CLOSEST meaning: A 'self-guided' tour lets you explore at your own pace.", options: ["independent", "directed", "guided", "private"], correct: 0, explanation: "Self-guided ≈ independent = tự lập, tự túc.", unit: 8 },
  { id: 95, question: "CLOSEST meaning: The operator provided a detailed 'itinerary'.", options: ["schedule", "list", "program", "tip"], correct: 0, explanation: "Itinerary ≈ schedule = lịch trình.", unit: 8 },
  { id: 96, question: "OPPOSITE meaning: The presentation was 'brilliant'.", options: ["excellent", "terrible", "bright", "exciting"], correct: 1, explanation: "Brilliant (tuyệt vời) ↔ Terrible (tệ).", unit: 12 },
  { id: 97, question: "OPPOSITE meaning: I felt a lot of 'confidence' when speaking.", options: ["certainty", "trust", "fear", "courage"], correct: 2, explanation: "Confidence (tự tin) ↔ Fear (sợ hãi).", unit: 12 },
